...
const Projects = () => {
  ...
  return (
    <div className={`${darkMode ? 'bg-black text-white' : 'bg-white text-black'} py-20`} id="project">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div
              key={project.id}
              className={`${darkMode ? 'bg-gray-800' : 'bg-gray-200'} p-6 rounded-lg hover:shadow-lg transform transition-transform duration-300 hover:scale-105`}
            >
              <img
              ...
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-700'} mb-4`}>{project.technologies}</p>
